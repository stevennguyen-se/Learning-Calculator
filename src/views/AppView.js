 ...
 */
digitClick = (digit) => {
    console.log('digitClick', digit, this.state.isResultClicked);
...
operationClick = (operationSign) =>{
    console.log('operationClick', operationSign, this.state.fullText);
 ...
 */
dotClick = () => {
    console.log('dotClick', this.state.fullisResultClickedText);
...
functionalButtonClick = (key) => {
    console.log('functionalButtonClick', key);
 ...
 */
equalClick = () => {
    console.log('equalClick', this.state.fullText);
...
checkKeyboardEvent = (event) => {
    console.log('checkKeyboardEvent');
...
shouldComponentUpdate() {
    console.log('---- %cshouldComponentUpdate', 'color: green; font-weight: bold;');
    console.log(this.state);
    return true;
}

componentDidUpdate(){
    console.log('---- %ccomponentDidUpdate', 'color: green; font-weight: bold;');
    console.log(this.state);
}
